...
test("getting data for non spotify url string should return rejection", () => {
  expect.assertions(1);
  return expect(getData("http://google.com/5a2w2tgpLwv26BYJf2qYwu")).rejects.toThrow();
});

test("get data for spotify track", () => {
  expect.assertions(4);
  return getData("https://open.spotify.com/track/5nTtCOCds6I0PHMNtqelas").then(result => {
...
test("get data for spotify artist", () => {
  expect.assertions(4);
  return getData("https://open.spotify.com/artist/5a2w2tgpLwv26BYJf2qYwu").then(result => {
...
test("get data for spotify album", () => {
  expect.assertions(4);
  return getData("https://open.spotify.com/album/4tDBsfbHRJ9OdcMO9bmnai").then(result => {
...
test("get data for spotify playlist", () => {
  expect.assertions(4);
  return getData("https://open.spotify.com/user/sophiemsmsmsm/playlist/3Q4cPwMHY95ZHXtmcU2xvH").then(result => {
...
test('get data for spotify episode', () => {
  expect.assertions(4)
  return getData('http://open.spotify.com/episode/64TORH3xleuD1wcnFsrH1E').then(result => {
